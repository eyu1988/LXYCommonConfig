...
@implementation UIImage (LXYRotate)
...
{
    return [self lxy_rotate:UIImageOrientationDownMirrored];
}

/** 水平翻转 */
- (UIImage *)lxy_flipHorizontal
{
    return [self lxy_rotate:UIImageOrientationUpMirrored];
}
...
{
    return [self lxy_imageRotatedByRadians:kDegreesToRadian(degrees)];
}
